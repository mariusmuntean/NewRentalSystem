...
public interface IClientService extends RemoteService {
	...
	/**
	 * Removes a device.
	 * @param imei - IMEI code of the device to be removed.
	 */
	Boolean deleteDevice(String imei);
	
	/**
	 * Adds a new renter to the DB.
	 * @param renter - the SerializableRenter obj to be added.
	 ...
	 * @param renter - SerializableRenter object to be deleted.
	 * @return
	 */
	 ...
	 * @param renter - A SerializableRenter object holding the updated info.
	 * @return
	 */
	Boolean updateRenter(SerializableRenter renter);
	 ...
	 * @param renterMatrNr - Renter's matriculation number.
	 * @param deviceImeiCode - IMEI code of rented device.
	 * @return
	 */
	Boolean rentDeviceTo(String renterMatrNr, String deviceImeiCode, String comments, String signatureHTML);
	
	/**
	 * Add multiple devices to someone's list of rented devices.
	 * @param renterMatrNr - Renter's matriculation number.
	 * @param imeiCodes - IMEI codes of newly rented devices.
	 * @return
	 */
	Boolean rentDevicesTo(String renterMatrNr, String[] imeiCodes, String comments, String signatureHTML);
	
	/**
	 * Remove a device from someone's rented devices list.
	 * @param renterMatrNr - Renter's matriculation number.
	 * @param deviceImeiCode - IMEI code of returned device.
	 * @return
	 */
	Boolean returnDevice(String renterMatrNr, String deviceImeiCode, String comments, String signatureHTML);
	
	/**
	 * Remove multiple devices from someone's rented device list.
	 * @param renterMatrNr - Renter's matriculation number.
	 * @param imeiCodes - IMEI codes of returned devices.
	 * @return
	 */
	Boolean returnDevices(String renterMatrNr, String[] imeiCodes, String comments, String signatureHTML);
	
	/**
	 * Returns events that satisfy the given criteria. Any of which is optional.
	 * @param personName - Events where this person is involved.
	 * @param IMEI - Events where this device is involved.
	 * @param from - Events that took place after this date.
	 * @param to - Events that took place before this date.
	 * @param maxResultSize - The upper limit for the result set size.
	 * @param reverseChronologicalOrder - Determines if the events should be returned in the order they happened(by default) or in reverse order.
	 * @return - A List of events.
	 */
	ArrayList<PersistentEvent> getEvents(String personName, String IMEI, Date from, Date to, Integer maxResultSize, Boolean reverseChronologicalOrder);
}
